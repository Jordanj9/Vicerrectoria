    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            <div class="panel-heading">
                <h4>Editar Datos de la Fecha de Aplicación <?php echo e($fecha->periodoacademico->anio . " - " . $fecha->periodoacademico->periodo . " --> " . $fecha->periodoacademico->TipoPeriodo->descripcion); ?></h4>
            </div>
            <div class="panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    <?php echo Form::open(['route'=>['fechaaplicacion.update',$fecha],'method'=>'PUT','class'=>'form-horizontal form-label-left']); ?>

                    <div class="form-group"><label class="col-sm-2 control-label text-right">Periodo Académico</label>
                        <div class="col-sm-10">
                            <?php echo Form::select('periodoacademico_id',$periodos,$fecha->periodoacademico_id,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'periodoacademico_id']); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Fecha Inicial</label>
                        <div class="col-sm-10">
                            <input class="form-control col-md-7 col-xs-12"  value="<?php echo e($fecha->fechainicio); ?>" name="fechainicio" type="date" placeholder="Inicio de la evaluacion académica" required="required" />
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Fecha Final</label>
                        <div class="col-sm-10">
                            <input class="form-control col-md-7 col-xs-12" value="<?php echo e($fecha->fechafin); ?>" name="fechafin" type="date" placeholder="Ultimo plazo para evaluación académica" required="required" />
                        </div>
                    </div>
