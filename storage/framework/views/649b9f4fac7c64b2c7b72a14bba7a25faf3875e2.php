    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="<?php echo e(route('inicio')); ?>">Inicio</a> <span class="fa-angle-right fa"></span><a href="<?php echo e(route('admin.evaluacionautohetero')); ?>"> Módulo Evaluación Académica </a><span class="fa-angle-right fa"></span><a href="<?php echo e(route('docenteexamen.index')); ?>">Gestión de Pares </a> <span class="fa-angle-right fa"></span> Crear
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                ...
                <div class="col-md-12">
                    <?php echo Form::open(['route'=>'docenteexamen.store','method'=>'POST','class'=>'form-horizontal form-label-left']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <?php echo Form::label('docenteacademico_id', 'Seleccione el Par', ['class' => 'control-label']); ?>

                            <?php echo Form::select('docenteacademico_id',$docentes,null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'tipo']); ?>

                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="<?php echo e(route('docenteexamen.index')); ?>" class="btn btn-3d btn-danger">Cancelar</a>
...
<script type="text/javascript">
    ...
    function getPersona() {
        ...
        if (id.length === 0) {
            ...
            $.ajax({
                type: 'GET',
                url: url + "evaluacionacademica/docenteexamen/" + id + "/get/docentes",
                data: {},
            }).done(function (msg) {
