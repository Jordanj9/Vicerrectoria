    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    <?php echo Form::open(['route'=>'cargo.store','method'=>'POST','class'=>'form-horizontal form-label-left']); ?>

                    <div class="form-group"><label class="col-sm-2 control-label text-right">Código</label>
                        <div class="col-sm-10">
                            <?php echo Form::text('codigo',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Código del cargo asignado por la universidad','required']); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Nombre</label>
                        <div class="col-sm-10">
                            <?php echo Form::text('nombre',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Nombre del cargo','required']); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Descripción</label>
                        <div class="col-sm-10">
                            <?php echo Form::text('descripcion',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Descripción del cargo','required']); ?>

                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Número de Empleados</label>
                        <div class="col-sm-10">
                            <?php echo Form::number('numero_empleados',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Cantidad de empleados que pueden ser contratados en éste cargo']); ?>
