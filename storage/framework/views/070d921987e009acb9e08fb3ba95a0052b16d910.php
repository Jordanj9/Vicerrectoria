        ...
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                ...
                <div class="col-md-12" style="margin-top: 30px;">
                    <?php echo Form::open(['route'=>'docentes.store','method'=>'POST','class'=>'form-horizontal form-label-left']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            ...
                            <?php echo Form::text('codigo',null,['class'=>'form-control','placeholder'=>'Código asignado por la universidad']); ?>
                    ...
                    <div class="form-group"
                        <div class="col-md-12">
                            <?php echo Form::label('tipo', 'Cargo', ['class' => 'control-label']); ?>

                            <?php echo Form::select('cargo_id',$cargos,null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','id'=>'cargo_id','required']); ?>

                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-9 col-sm-9 col-xs-12 col-md-offset-3">
                            <a href="<?php echo e(route('docentes.index')); ?>" class="btn btn-3d btn-danger">Cancelar</a>
