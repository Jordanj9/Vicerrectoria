    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="<?php echo e(route('inicio')); ?>">Inicio</a> <span class="fa-angle-right fa"></span><a href="<?php echo e(route('admin.evaluacionautohetero')); ?>"> Módulo Evaluación Académica </a><span class="fa-angle-right fa"></span><a href="<?php echo e(route('jefedepartamento.index')); ?>">Asignar Jefe </a> <span class="fa-angle-right fa"></span> Crear
            </p>
        </div>
    </div>
</div>
...
<!--                <div class="col-md-12" style="margin-top: 20px;">
                ...
                <div class="col-md-12">
                    <?php echo Form::open(['route'=>'jefedepartamento.store','method'=>'POST','class'=>'form-horizontal form-label-left']); ?>

                    <div class="form-group">
                        <div class="col-md-12">
                            <?php echo Form::label('docentejefe', 'Seleccione el Jefe', ['class' => 'control-label']); ?>

                            <?php echo Form::select('docentejefe',$docentes,null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'docentejefe']); ?>
...
<!--                    <div class="form-group">
                        <div class="col-md-4">
                            ...
                            <?php echo Form::text('ident',null,['class'=>'form-control','placeholder'=>'Identificación de la persona','required','id'=>'ident']); ?>

                        </div>
                        <div class="col-md-8">
                            <label class="control-label">Futuro Encargado de Programa</label>
                            <?php echo Form::text('persona',null,['class'=>'form-control','placeholder'=>'Persona natural','id'=>'persona']); ?>

                        </div>
                    </div>-->
                    <div class="form-group">
                        <div class="col-md-12">
                            <?php echo Form::label('docenteacademico_pege', 'Seleccione el Docente', ['class' => 'control-label']); ?>

                            <?php echo Form::select('docenteacademico_pege',$docentes,null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'docenteacademico']); ?>
