        ...
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            <?php echo Form::label('facultad_id', 'Facultad', ['class' => 'control-label']); ?>

                            <?php echo Form::select('facultad_id',$facultad,null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'facultad_id','onchange'=>'getDepartamentos()']); ?>

                        </div>
                        <div class="col-md-6">
                            <?php echo Form::label('departamento_id', 'Departamento', ['class' => 'control-label']); ?>

                            <?php echo Form::select('departamento_id',[],null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'departamento_id']); ?>
