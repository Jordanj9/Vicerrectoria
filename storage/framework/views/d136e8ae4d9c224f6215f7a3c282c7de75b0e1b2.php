    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            <div class="panel-heading">
                <h4>Editar Datos del Docente <?php echo e($p->primer_nombre." ".$p->primer_apellido); ?></h4>
            </div>
            <div class="panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    <?php echo Form::open(['route'=>['pnaturales.update',$p],'method'=>'PUT','class'=>'form-horizontal form-label-left']); ?>

                    <legend>Datos Personales</legend>
                    <div class="form-group">
                        <div class="col-md-3">
                            <label class="control-label">Primer Nombre</label>
                            <?php echo Form::text('primer_nombre',$p->primer_nombre,['class'=>'form-control','required']); ?>

                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Segundo Nombre</label>
                            <?php echo Form::text('segundo_nombre',$p->segundo_nombre,['class'=>'form-control']); ?>

                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Primer Apellido</label>
                            <?php echo Form::text('primer_apellido',$p->primer_apellido,['class'=>'form-control','required']); ?>

                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Segundo Apellido</label>
                            <?php echo Form::text('segundo_apellido',$p->segundo_apellido,['class'=>'form-control']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-3">
                            ...
                            <?php if($p->persona!==null): ?>
                            <?php echo Form::select('tipodoc_id',$tipodocs,$p->persona->tipodoc_id,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required']); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <?php if($p->persona!==null): ?>
                            <?php echo Form::text('numero_documento',$p->persona->numero_documento,['class'=>'form-control','placeholder'=>'Número del documento de identificación','required']); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <?php if($p->persona!==null): ?>
                            <?php echo Form::text('lugar_expedicion',$p->persona->lugar_expedicion,['class'=>'form-control']); ?>
                        ...
                        <div class="col-md-3">
                            ...
                            <?php if($p->persona!==null): ?>
                            <?php echo Form::date('fecha_expedicion',$p->persona->fecha_expedicion,['class'=>'form-control']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-2">
                            ...
                            <?php echo Form::text('libreta_militar',$p->libreta_militar,['class'=>'form-control']); ?>

                        </div>
                        <div class="col-md-2">
                            <label class="control-label">Distrito Militar</label>
                            <?php echo Form::text('distrito_militar',$p->distrito_militar,['class'=>'form-control']); ?>

                        </div>
                        <div class="col-md-2">
                            <?php echo Form::label('tipo', 'Tipo Sanguíneo', ['class' => 'control-label']); ?>

                            <?php echo Form::select('rh',['A+'=>'A+','A-'=>'A-','B+'=>'B+','B-'=>'B-','AB+'=>'AB+','AB-'=>'AB-','O+'=>'O+','O-'=>'O-'],$p->rh,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --']); ?>

                        </div>
                        <div class="col-md-2">
                            <?php echo Form::label('tipo', 'Sexo', ['class' => 'control-label']); ?>

                            <?php echo Form::select('sexo',['F'=>'F','M'=>'M'],$p->sexo,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required']); ?>

                        </div>
                        <div class="col-md-3">
                            <?php echo Form::label('tipo', 'Fecha de Nacimiento', ['class' => 'control-label']); ?>

                            <?php echo Form::date('fecha_nacimiento',$p->fecha_nacimiento,['class'=>'form-control']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-4">
                            ...
                            <?php if($p->persona!==null): ?>
                            <?php echo Form::text('direccion',$p->persona->direccion,['class'=>'form-control']); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <?php if($p->persona!==null): ?>
                            <?php echo Form::text('telefono1',$p->persona->telefono,['class'=>'form-control']); ?>
                        ...
                        <div class="col-md-4">
                            ...
                            <?php if($p->persona!==null): ?>
                            <?php echo Form::text('telefono2',$p->persona->celular,['class'=>'form-control']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-6">
                            ...
                            <?php if($p->persona!==null): ?>
                            <?php echo Form::text('email',$p->persona->mail,['class'=>'form-control']); ?>
                        ...
                        <div class="col-md-6">
                            <label class="control-label">Correo Institucional : <?php echo e($p->email_institucional); ?></label>
                            <?php echo Form::text('email_institucional',$p->email_institucional,['class'=>'form-control']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <label class="control-label">Departamento Actual: <?php echo e($p->departamento->nombre); ?></label>
