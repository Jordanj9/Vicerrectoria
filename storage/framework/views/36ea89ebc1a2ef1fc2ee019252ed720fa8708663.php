    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                ...
                <div class="col-md-12">
                    <?php echo Form::open(['route'=>'asignarpar.store','method'=>'POST','class'=>'form-horizontal form-label-left']); ?>
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            <?php echo Form::label('docenteacademico_pege', 'Seleccione el Par', ['class' => 'control-label']); ?>

                            <?php echo Form::select('docenteacademico_pege',$docentes,null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'tipo']); ?>

                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="<?php echo e(route('asignarpar.index')); ?>" class="btn btn-3d btn-danger">Cancelar</a>
