    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    {!! Form::open(['route'=>'pnaturales.store','method'=>'POST','class'=>'form-horizontal form-label-left'])!!}
                    <legend>Datos Personales</legend>
                    <div class="form-group">
                        <div class="col-md-3">
                            <label class="control-label">Primer Nombre</label>
                            {!! Form::text('primer_nombre',null,['class'=>'form-control','required']) !!}
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <div class="col-md-2">
                            ...
                            {!! Form::text('libreta_militar',null,['class'=>'form-control']) !!}
                        </div>
                        <div class="col-md-2">
                            <label class="control-label">Distrito Militar</label>
                            {!! Form::text('distrito_militar',null,['class'=>'form-control']) !!}
                        </div>
                        <div class="col-md-2">
                            {!! Form::label('tipo', 'Tipo Sanguíneo', ['class' => 'control-label'])!!}
                            {!! Form::select('rh',['A+'=>'A+','A-'=>'A-','B+'=>'B+','B-'=>'B-','AB+'=>'AB+','AB-'=>'AB-','O+'=>'O+','O-'=>'O-'],null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --']) !!}
                        </div>
                        <div class="col-md-2">
                            {!! Form::label('tipo', 'Sexo', ['class' => 'control-label'])!!}
                            {!! Form::select('sexo',['F'=>'F','M'=>'M'],null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required']) !!}
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            {!! Form::email('email_institucional',null,['class'=>'form-control']) !!}
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            {!! Form::label('tipo', 'Departamento', ['class' => 'control-label'])!!}
