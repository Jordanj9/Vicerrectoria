    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            <div class="panel-heading">
                <h4>Editar Datos del Cargo {{$cargo->nombre}}</h4>
            </div>
            <div class="panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    {!! Form::open(['route'=>['cargo.update',$cargo],'method'=>'PUT','class'=>'form-horizontal form-label-left'])!!}
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Código</label>
                        <div class="col-sm-10">
                            {!! Form::text('codigo',$cargo->codigo,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Código del cargo asignado por la universidad','required']) !!}
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Nombre</label>
                        <div class="col-sm-10">
                            {!! Form::text('nombre',$cargo->nombre,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Nombre del cargo','required']) !!}
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Descripción</label>
                        <div class="col-sm-10">
                            {!! Form::text('descripcion',$cargo->descripcion,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Descripción del cargo','required']) !!}
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Número de Empleados</label>
                        <div class="col-sm-10">
                            {!! Form::number('numero_empleados',$cargo->numero_empleados,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Cantidad de empleados que pueden ser contratados en éste cargo']) !!}
                        </div>
                    </div>
                    <div class="form-group form-animate-checkbox col-md-12">
                        @if($cargo->tiene_funcion!='0')
