    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    {!! Form::open(['route'=>'periodoa.store','method'=>'POST','class'=>'form-horizontal form-label-left'])!!}
                    <div class="form-group">
                        <div class="col-md-4">
                            <label class="control-label">Tipo de Período</label>
                            {!! Form::select('tipo_periodo_id',$tipos,null,['class'=>'form-control col-md-7 col-xs-12 chosen-select','placeholder'=>'-- Seleccione una opción --','required']) !!}
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <div class="col-md-3">
                            ...
                            {!! Form::text('anio',null,['class'=>'form-control','placeholder'=>'Año para el período','required']) !!}
                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Período</label>
                            {!! Form::text('periodo',null,['class'=>'form-control','placeholder'=>'Período del año']) !!}
                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Fecha Inicio Clases</label>
                            {!! Form::date('fechainicioclases',null,['class'=>'form-control','required']) !!}
                        </div>
                        <div class="col-md-3">
                            <label class="control-label">Fecha Fin Clases</label>
                            {!! Form::date('fechafinclases',null,['class'=>'form-control','required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
