...
<div class="col-md-12">
    <div class="alert alert-success alert-border alert-dismissible fade in" role="alert">
        ...
        <p>Agregue nuevos tipos de documentos. Contiene la información de los Tipos de Documentos.</p>
    </div>
</div>
<div class="col-md-12">
    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    {!! Form::open(['route'=>'tipodoc.store','method'=>'POST','class'=>'form-horizontal form-label-left'])!!}
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Tipo de Documento</label>
                        <div class="col-sm-10">
                            {!! Form::text('descripcion',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Nombre o descripción del tipo de documento','required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('tipo_persona', 'Seleccione Tipo de Persona', ['class' => 'col-sm-2 control-label text-right'])!!}
                        <div class="col-sm-10">
                            {!! Form::select('tipo_persona',['J'=>'JURÍDICA','N'=>'NATURAL'],null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'-- Seleccione una opción --','required']) !!}
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Abreviatura</label>
                        <div class="col-sm-10">
                            {!! Form::text('abreviatura',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Abreviatura del tipo de documento, ejemplo: para cedula CC']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('tipo', 'Seleccione Juego de Caracteres Permitidos', ['class' => 'col-sm-2 control-label text-right'])!!}
                        <div class="col-sm-10">
                            {!! Form::select('tipo',['NUMERICO'=>'NUMERICO','ALFABETICO'=>'ALFABETICO','ALFANUMERICO'=>'ALFANUMERICO','TODOS'=>'TODOS'],null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'-- Seleccione una opción --']) !!}
                        </div>
                    </div>
                    <div class="form-group">
