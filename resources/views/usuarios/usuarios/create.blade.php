    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.usuarios')}}"> Módulo Usuarios </a><span class="fa-angle-right fa"></span> Crear Usuario Manual
            </p>
        </div>
    </div>
</div>
...
<!--                <div class="col-md-12" style="margin-top: 20px;">
                ...
                <div class="col-md-12" style="margin-top: 40px;">
                    {!! Form::open(['route'=>'usuario.store','method'=>'POST','class'=>'form-horizontal form-label-left'])!!}
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Identificación del Usuario</label>
                        <div class="col-sm-10">
                            {!! Form::text('identificacion',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Escriba el número de identificación del usuario, con éste tendrá acceso al sistema','required','id'=>'identificacion']) !!}
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Nombres del Usuario</label>
                        <div class="col-sm-10">
                            {!! Form::text('nombres',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Escriba los nombres del usuario','required','id'=>'txt_nombres']) !!}
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">Apellidos del Usuario</label>
                        <div class="col-sm-10">
                            {!! Form::text('apellidos',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Escriba los apellidos del usuario','required','id'=>'txt_apellidos']) !!}
                        </div>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label text-right">E-mail del Usuario</label>
                        <div class="col-sm-10">
                            {!! Form::email('email',null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'Escriba el correo electrónico del usuario','required','id'=>'txt_email']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('grupos', 'Seleccione Estado del Usuario', ['class' => 'col-sm-2 control-label text-right'])!!}
                        <div class="col-sm-10">
                            {!! Form::select('estado',['ACTIVO'=>'ACTIVO','INACTIVO'=>'INACTIVO'],null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'-- Seleccione una opción --','required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        {!! Form::label('grupos', 'Seleccione los Grupos o Roles de Usuarios', ['class' => 'col-sm-2 control-label text-right'])!!}
                        <div class="col-sm-10">
                            {!! Form::select('grupos[]',$grupos,null,['class'=>'form-control col-md-7 col-xs-12 chosen-select','placeholder'=>'-- Seleccione una opción --','required','multiple']) !!}
                        </div>
                    </div>
