    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio </a> <span class="fa-angle-right fa"></span><a href="{{route('admin.usuarios')}}"> Módulo Usuarios </a><span class="fa-angle-right fa"></span> Privilegios a Páginas
            </p>
        </div>
    </div>
</div>
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="form-group">
                        {!! Form::label('grupousuario_id', 'Seleccione Grupo o Rol de Usuario', ['class' => 'col-sm-2 control-label text-right'])!!}
                        <div class="col-sm-10">
                            {!! Form::select('grupousuario_id',$grupos,null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'-- Seleccione una opción --','onchange="traerData()"']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-12" style="margin-top: 20px;">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            {!! Form::select('paginas[]',$paginas,null,['class'=>'form-control col-md-7 col-xs-12','placeholder'=>'-- Seleccione una opción --','multiple', 'size="20"','id'=>'paginas']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-12" style="margin-top:20px">
                ...
                <div class="col-md-12" style="margin-top: 20px;">
                    ...
                    {!! Form::open(['route'=>'grupousuario.guardar','method'=>'POST','name'=>'form-privilegios','id'=>'form-privilegios'])!!}
                    <div class="form-group">
                        <div class="col-sm-10">
                            {!! Form::hidden('id',null,['class'=>'form-control col-md-7 col-xs-12','id'=>'id']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-12">
