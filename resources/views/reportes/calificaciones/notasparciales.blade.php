    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repcalificaciones')}}"> Calificaciones </a><span class="fa-angle-right fa"></span> Notas Parciales Históricas del Estudiante 
            </p>
        </div>
        </div>
    </div>
...
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4>Reporte de Notas Parciales Históricas del Estudiante</h4>
        </div>
        <div class="panel-body">
            <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf(id) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/calificaciones/" + id +"/notasparciales/pdf";
            a.click();
    }
