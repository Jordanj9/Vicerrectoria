    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Mejores Promedios de Estudiantes</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (u == null || p == null || id.length <= 0) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/calificaciones/" + u + "/" + p + "/" + v[1] + "/mejorpromedio/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (u == null || p == null || id.length <= 0) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/calificaciones/" + u + "/" + p + "/" + v[1] + "/mejorpromedio/excel";
            a.click();
        }
    }
