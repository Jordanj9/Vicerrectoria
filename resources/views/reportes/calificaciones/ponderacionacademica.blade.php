    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repcalificaciones')}}"> Calificaciones </a><span class="fa-angle-right fa"></span> Ponderación Académica del Estudiante
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Ponderación Académica del Estudiante</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                    <div class='form-horizontal form-label-left'>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                {!! Form::label('tipo', 'Tipo', ['class' => 'control-label text-right'])!!}
                                {!! Form::select('tipo',['1'=>'PERÍODO ACTUAL','0'=>'PERÍODO HISTÓRICO'],null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','id'=>'tipo_id']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        var id = $("#programa").val();
        var t = $("#tipo_id").val();
        if (u == null || p == null || t == null || id.length <= 0) {
            notify('Alerta', 'Debe indicar todos los parámetros para continuar', 'warning');
        } else {
            var v = id.split(";");
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/calificaciones/" + v[1] + "/" + u + "/" + p + "/" + t + "/ponderacionacademica/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (u == null || p == null || t == null || id.length <= 0) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/calificaciones/" + v[1] + "/" + u + "/" + p + "/" + t + "/ponderacionacademica/excel";
            a.click();
        }
    }
