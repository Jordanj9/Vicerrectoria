    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Admisión: Admitidos Por Tipo de Admisión</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-4">
                            <label class="control-label">Tipo de Admisión</label>
                            {!! Form::select('tipoadmision',$tipo,null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'tipoadmision']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf() {
        var p = $("#programa").val();
        var t = $("#tipoadmision").val();
        if (t == null) {
            notify('Alerta', 'Debe indicar todos los parámetros para continuar', 'warning');
        } else {
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $per->id ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + p + "/" + t + "/menu/admitidosxtipoadmision/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (t == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $per->id ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + p + "/" + t + "/menu/admitidosxtipoadmision/excel";
            a.click();
        }
    }
