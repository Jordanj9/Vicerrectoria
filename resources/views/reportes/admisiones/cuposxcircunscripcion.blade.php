    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Admisión: Cupos por Circunscripción y Programas</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            {!! Form::select('estadoc',['TODAS'=>'TODAS','ABIERTA'=>'ABIERTA','CERRADA'=>'CERRADA','CANCELADA'=>'CANCELADA'],null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'estadoc']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf() {
        var p = $("#programa").val();
        var orden = $("#estadoc").val();
        if (orden == null) {
            notify('Alerta', 'Debe indicar todos los parámetros para continuar', 'warning');
        } else {
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + p + "/" + orden + "/menu/cuposxcircunscripcion/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (orden == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + p + "/" + orden + "/menu/cuposxcircunscripcion/excel";
            a.click();
        }
    }
