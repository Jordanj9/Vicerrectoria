    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Admisión: Transferencia Externa</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            {!! Form::select('orden',['nombres'=>'NOMBRES','identificacion'=>'IDENTIFICACIÓN','programaproviene'=>'PROGRAMA DE PROCEDENCIA'],null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'orden']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
...
<!--                    <div class="col-md-6">
                        <div class="form-group" style="text-align: center;">
                            ...
                            <a target="_blank" class="btn btn-circle ripple-infinite btn-lg btn-success"><div><span class="fa fa-file-excel-o"></span></div></a>
                        </div>
                    </div>-->
                </div>
            </div>
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (orden == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $per->id ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + p + "/" + orden + "/menu/transferenciaexterna/pdf";
            a.click();
        }
    }
