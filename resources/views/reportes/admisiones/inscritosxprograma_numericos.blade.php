                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-4">
                            ...
                            {!! Form::select('estadoadmision',['ASPIRANTE'=>'ASPIRANTE','ADMITIDO'=>'ADMITIDO','ANULADO'=>'ANULADO','NO ADMITIDO'=>'NO ADMITIDO','TODOS'=>'TODOS LOS INSCRITOS'],null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'estadoadmision']) !!}
                        </div>
                        <div class="col-md-4">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (ea == null || orden == null || ec == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $per->id ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + p + "/" + ea + "/" + orden + "/" + ec + "/menu/inscritosxprograma/numericos/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (ea == null || orden == null || ec == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $per->id ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + p + "/" + ea + "/" + orden + "/" + ec + "/menu/inscritosxprograma/numericos/excel";
            a.click();
        }
    }
