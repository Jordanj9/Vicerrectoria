    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span> Admisiones
            </p>
        </div>
    </div>
</div>
...
<div class="col-md-12 top-20 padding-0">
    <div class="col-md-12">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    {!! Form::open(['route'=>'admisiones.store','method'=>'POST','class'=>'form-horizontal form-label-left'])!!}
