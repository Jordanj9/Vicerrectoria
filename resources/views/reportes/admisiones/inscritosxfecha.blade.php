    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Admisión: Inscritos Por Fechas</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-6">
                            ...
                            <input class="form-control" type="datetime-local" name="fechainicio" id="fechai"/>
                        </div>
                        <div class="col-md-6">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (fi == null || ff == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $per->id ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + fi + "/" + ff + "/menu/inscritosxfecha/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (fi == null || ff == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $per->id ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + fi + "/" + ff + "/menu/inscritosxfecha/excel/reporte";
            a.click();
        }
    }
