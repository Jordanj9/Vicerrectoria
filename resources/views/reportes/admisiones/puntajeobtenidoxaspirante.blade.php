    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Admisión: Puntaje Obtenido Aspirante</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            {!! Form::select('orden',['nombres'=>'NOMBRES','identificacion'=>'IDENTIFICACIÓN','puntaje'=>'PUNTAJE OBTENIDO'],null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'orden']) !!}
                        </div>
                    </div>
                </div>
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (orden == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $per->id ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + p + "/" + orden + "/menu/puntajeobtenidoxaspirante/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (orden == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/admisiones/<?php echo $u->id; ?>/<?php echo $per->id ?>/<?php echo $me->id ?>/<?php echo $mo->id ?>/<?php echo $ne->id ?>/" + p + "/" + orden + "/menu/puntajeobtenidoxaspirante/excel";
            a.click();
        }
    }
