...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Reportes - Reportes de Horarios</h3>
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.rephorarios')}}"> Horarios </a><span class="fa-angle-right fa"></span> Horario de Estudiante
            </p>
        </div>
    </div>
</div>
<div class="col-md-12">
    <div class="alert alert-primary alert-border alert-dismissible fade in" role="alert">
        ...
        <p>Esta funcionalidad permite la búsqueda del horario de clases semanales asignadas a un estudiante por datos personales o unidad.</p>
    </div>
</div>
                    ...
                    <form class='form-horizontal form-label-left'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                ...
                                {!! Form::select('unidad_id',[],null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'unidad_id','onchange'=>'getPeriodos()']) !!}
                            </div>
                            <div class="col-md-4">
...
<script type="text/javascript">
            ...
            if (msg !== 'null') {
                ...
                $.each(m, function (index, item) {
                    html = html + "<tr>"
                            ...
                            + "<td><a onclick='continuar(" + item.id + ")' class='btn btn-success btn-xs'>Continuar</a></td>"
                            + "</tr>";
                });
    ...
    function continuar(id) {
        ...
        if (per !== null) {
            ...
            a.target = "_blank";
            a.href = url + "academico/horario/horarioestudianteadmin/" + id + "/" + per + "/solicitar/enviar";
            a.click();
        } else {
            notify('Alerta', 'Debe indicar el período de matrícula a consultar horario.', 'error');
        }
    }
</script>
@endsection