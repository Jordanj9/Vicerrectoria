...
<div class="panel box-shadow-none content-header">
    <div class="panel-body">
        <div class="col-md-12">
            <h3 class="animated fadeInLeft">Reportes - Reportes de Sanciones</h3>
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repsanciones')}}"> Sanciones </a><span class="fa-angle-right fa"></span> Sanciones por Estudiante 
            </p>
        </div>
        </div>
    </div>
...
<div class="col-md-12">
    <div class="alert alert-primary alert-border alert-dismissible fade in" role="alert">
        ...
        <p>Obtenga reportes del proceso de Sanciones.</p>
    </div>
</div>
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h4>Reporte de Sanciones por Estudiantes</h4>
        </div>
        <div class="panel-body">
            <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf(id) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/sanciones/" + id +"/porestudiante/pdf";
            a.click();
    }
    ...
    function excel(id) {
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/sanciones/" + id +"/porestudiante/excel";
            a.click();
    }
            ...
            if (msg !== 'null') {
                ...
                $.each(m, function (index, item) {
                    html = html + "<tr>"
                            ...
                            + "<a onclick='excel(" + item.id + ")' class='btn btn-success btn-xs' data-toggle='tooltip' data-placement='top' title='Descargar EXCEL'><i class='fa fa-file-excel-o'></i></a>"
                            + "</td>"
                            + "</tr>";
                });
