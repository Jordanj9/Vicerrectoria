    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repmatacademica')}}"> Matricula Académica </a><span class="fa-angle-right fa"></span> Matriculados por Materias
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes Matriculados por Materia</h3>
            </div>
            <div class="panel-body">
                        ...
                        <div class="responsive-table panel box-v1">
                            <table id="tabla" class="table table-hover table-responsive table-bordered table-condensed" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{$d->codigomateria}}</td>
                                        <td>{{$d->nombre}}</td>
                                        <td>{{$d->ponderacionacademica}}</td>
                                        <td><a class="btn btn-xs btn-danger" onclick="pdf(this.id)" id="{{$d->codigomateria}}"><span class="fa fa-file-pdf-o"></span></a>
                                            <a class="btn btn-xs btn-success" onclick="excel(this.id)" id="{{$d->codigomateria}}"><span class="fa fa-file-excel-o"></span></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
...
<script type="text/javascript">
    ...
    function pdf(id) {
        ...
        if (p == null || u == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/matricula/" + id + "/" + p + "/" + u + "/matxmateria/pdf";
            a.click();
        }
    }
    ...
    function excel(id) {
        ...
        if (p == null || u == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/matricula/" + id + "/" + p + "/" + u + "/matxmateria/excel";
            a.click();
        }
    }
