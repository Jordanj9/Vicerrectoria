    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repmatacademica')}}"> Matricula Académica </a><span class="fa-angle-right fa"></span> Cancelación de Semestre
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Cancelación de Semestre</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (u == null || p == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/matricula/" + u + "/" + p + "/cancelarsemestre/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (u == null || p == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/matricula/" + u + "/" + p + "/cancelarsemestre/excel";
            a.click();
        }
    }
