    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repmatacademica')}}"> Matricula Académica </a><span class="fa-angle-right fa"></span> Hoja de Vida del Estudiante
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Hoja de Vidad del Estudiante</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
            ...
            if (msg !== 'null') {
                ...
                $.each(m, function (index, item) {
                    html = html + "<tr>"
                            ...
                            + "<td><a target='_blank' href='" + url + "reportes/matricula/" + item.id + "/hojadevidaest/pdf' class='fa fa-file-pdf-o'></a></td>"
                            + "</tr>";
                });
