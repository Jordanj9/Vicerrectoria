    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repmatacademica')}}"> Matricula Académica </a><span class="fa-angle-right fa"></span> Estudiantes con Ubicación Semestral
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Estudiantes con Ubicación Semestral</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                    <div class='form-horizontal form-label-left'>
                        <div class="form-group">
                            <div class="col-md-12">
                                ...
                                {!! Form::select('unidad_id',$unds,null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'unidad_id']) !!}
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-4">
...
<script type="text/javascript">
    ...
    function pdf() {
        var u = $("#unidad_id").val();
        var id = $("#programa").val();
        if (u == null || id.length <= 0) {
            notify('Alerta', 'Debe indicar todos los parámetros para continuar', 'warning');
        } else {
            var v = id.split(";");
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/matricula/" + v[1] + "/" + u + "/ubicacionsemestral/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (u == null || id.length <= 0) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/matricula/" + v[1] + "/" + u + "/ubicacionsemestral/excel";
            a.click();
        }
    }
