    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repcargaadmin')}}"> Matricula Académica </a><span class="fa-angle-right fa"></span> Reporte Grupo, Docente y Materia
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Grupo, Docente y Materia</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            {!! Form::select('docente_id',$response,null,['class'=>'form-control col-md-7 col-xs-12 chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'docente_id']) !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-6">
...
<script type="text/javascript">
    ...
    function excel() {
        ...
        if (u == null || p == null || t == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/cargaadmin/" + u + "/" + p + "/" + t + "/cargaacademica/excel";
            a.click();
        }
    }
