    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repcargaadmin')}}"> Carga Administrativa </a><span class="fa-angle-right fa"></span> Docentes por Unidad Académica
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Docentes por Unidad Académica</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (u == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/cargaadmin/" + u + "/docacademica/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (u == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/cargaadmin/" + u + "/docacademica/excel";
            a.click();
        }
    }
