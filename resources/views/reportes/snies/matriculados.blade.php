    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span> <a href="{{route('snies.index')}}"> Snies y Spadies </a><span class="fa-angle-right fa"></span> Matriculados
            </p>
        </div>
    </div>
</div>
<div class="col-md-12">
    <div class="alert alert-primary alert-border alert-dismissible fade in" role="alert">
        ...
        <p>Reporte de matriculados en un período académico indicado.</p>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (p == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/snies/matriculados/inicio/" + p + "/" + ac + "/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (p == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/snies/matriculados/inicio/" + p + "/" + ac + "/excel";
            a.click();
        }
    }
</script>
