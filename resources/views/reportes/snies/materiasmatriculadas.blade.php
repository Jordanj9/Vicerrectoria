    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span> <a href="{{route('snies.index')}}"> Snies y Spadies </a><span class="fa-angle-right fa"></span> Materias Matriculadas
            </p>
        </div>
    </div>
</div>
<div class="col-md-12">
    <div class="alert alert-primary alert-border alert-dismissible fade in" role="alert">
        ...
        <p>Reporte de materias matriculadas por los estudiantes y aprobadas por la institución en un período académico indicado.</p>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reporte Materias Matriculadas</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (p == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/snies/materiasmatriculadas/inicio/" + p + "/" + ac + "/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (p == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/snies/materiasmatriculadas/inicio/" + p + "/" + ac + "/excel";
            a.click();
        }
    }
</script>
