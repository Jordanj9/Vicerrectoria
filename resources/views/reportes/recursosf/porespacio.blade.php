    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.reprecursosfisicos')}}"> Recuros Físicos </a><span class="fa-angle-right fa"></span> Recursos Físicos por Tipo, Espacio y Localidad
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Recursos Físicos por Tipo, Espacio y Localidad</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-4">
                            ...
                            {!! Form::select('localidad_id',$l,null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'localidad_id','onchange'=>'getEf()']) !!}
                        </div>
                        <div class="col-md-4">
                            {!! Form::label('tipo', 'Espacio Físico', ['class' => 'control-label'])!!}
                            {!! Form::select('espaciofisico',[],null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'espaciofisico']) !!}
                        </div>
                        <div class="col-md-4">
                            <label class="control-label">Tipo de Recurso Físico</label>
                            {!! Form::select('tipo_id',$t,null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'tipo_id']) !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-6">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (u == null || p == null || e == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/recursos/porespacio/" + p + "/" + e + "/pdf";
            a.click();
        }
    }
