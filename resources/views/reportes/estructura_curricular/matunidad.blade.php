    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repestructuracurricular')}}"> Estructura Curricular </a><span class="fa-angle-right fa"></span> Matricula por Unidad Académica
            </p>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (u == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/estructura/" + u + "/matunidad/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (u == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/estructura/" + u + "/matunidad/excel";
            a.click();
        }
    }
