    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repestructuracurricular')}}"> Estructura Curricular </a><span class="fa-angle-right fa"></span> Fundamentación Téorica de Programa
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Fundamentación Téorica de Programa</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (u == null || id.length <= 0) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/estructura/" + v[0] + "/" + u + "/fundamentopro/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (u == null || id.length <= 0) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
             a.href = url + "reportes/estructura/" + v[0] + "/" + u + "/fundamentopro/excel";
            a.click();
        }
    }
