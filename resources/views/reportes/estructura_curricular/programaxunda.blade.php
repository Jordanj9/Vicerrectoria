    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repestructuracurricular')}}"> Estructura Curricular </a><span class="fa-angle-right fa"></span> Programas por Unidad Académica
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Programas por Unidad Académica</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
                    <div class="form-group">
                        <div class="col-md-12">
                            ...
                            {!! Form::select('unidad_id',$unda,null,['class'=>'form-control','placeholder'=>'-- Seleccione una opción --','required','id'=>'unidad_id']) !!}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="col-md-6">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (u == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/estructura/" + u + "/programaxunda/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (u == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/estructura/" + u + "/programaxunda/excel";
            a.click();
        }
    }
