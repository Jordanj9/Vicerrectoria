    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.reportes')}}"> Módulo Reportes </a><span class="fa-angle-right fa"></span><a href="{{route('admin.repdeudas')}}"> Deudas </a><span class="fa-angle-right fa"></span> Reporte de Deudores
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel">
            <div class="panel-heading">
                <h3>Reportes de Deudores por Periodo Académico</h3>
            </div>
            <div class="panel-body">
                <div class="col-md-12">
...
<script type="text/javascript">
    ...
    function pdf() {
        ...
        if (p == null) {
            ...
            a.target = "_blank";
            a.href = url + "reportes/deudas/" + p + "/" + u + "/deudores/pdf";
            a.click();
        }
    }
    ...
    function excel() {
        ...
        if (p == null) {
            ...
            var a = document.createElement("a");
            a.target = "_blank";
            a.href = url + "reportes/deudas/" + p + "/" + u + "/deudores/excel";
            a.click();
        }
    }
