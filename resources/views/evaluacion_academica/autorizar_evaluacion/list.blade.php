            ...
            <div class="modal-body">
                <div class="form-group">
                    <div class="col-md-6">
                        ...
                        {!! Form::select('rol',['JEFE'=>'JEFE','DOCENTE EN COMISION'=>'DOCENTE EN COMISION','VICERRECTOR'=>'VICERRECTOR','DECANO'=>'DECANO','RECTOR'=>'RECTOR','PARES'=>'PARES/COLABORADORES'],null,['class'=>'form-control chosen-select','required','id'=>'rol']) !!}
                    </div>
                    <div class="col-md-6">
