    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.evaluacionautohetero')}}"> Módulo Evaluación Académica </a><span class="fa-angle-right fa"></span> <a href="{{route('indicador.index')}}">Indicadores de Evaluación </a> <span class="fa-angle-right fa"></span> Crear Indicador
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    {!! Form::open(['route'=>'indicador.store','method'=>'POST','class'=>'form-horizontal form-label-left'])!!}
                    <div class="form-group">
                        <div class="col-md-5">
                            <label class="control-label">Indicador</label>
                            {!! Form::text('indicador',null,['class'=>'form-control','required']) !!}
                        </div>
                        <div class="col-md-7">
                            <label class="control-label">Criterio</label>
                            {!! Form::select('criterioevaluacion_id',$criterios,null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
