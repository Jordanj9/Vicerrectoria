    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span><a href="{{route('admin.evaluacionautohetero')}}"> Módulo Evaluación Académica </a><span class="fa-angle-right fa"></span> <a href="{{route('criterioe.index')}}">Criterios de Evaluación </a> <span class="fa-angle-right fa"></span> Editar Criterio
            </p>
        </div>
    </div>
</div>
    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            <div class="panel-heading">
                <h4>Editar Datos del Criterio {{$c->nombre}}</h4>
            </div>
            <div class="panel-body" style="padding-bottom:30px;">
                <div class="col-md-12">
                    {!! Form::open(['route'=>['criterioe.update',$c],'method'=>'PUT','class'=>'form-horizontal form-label-left'])!!}
                    <div class="form-group">
                        <div class="col-md-4">
                            <label class="control-label">Nombre del Criterio</label>
                            {!! Form::text('nombre',$c->nombre,['class'=>'form-control','placeholder'=>'Nombre del criterio','required']) !!}
                        </div>
                        <div class="col-md-4">
                            <label class="control-label">Descripción del Criterio</label>
                            {!! Form::text('descripcion',$c->descripcion,['class'=>'form-control','placeholder'=>'Descripción del criterio']) !!}
                        </div>
                        <div class="col-md-4">
                            <label class="control-label">Peso en %</label>
                            {!! Form::number('peso',$c->peso,['class'=>'form-control','placeholder'=>'Peso del criterio','max'=>'100','required'=>'required']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
