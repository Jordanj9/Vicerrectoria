    ...
    <div class="col-md-12">
        <div class="panel form-element-padding">
            ...
            <div class="panel-body" style="padding-bottom:30px;">
                ...
                <div class="col-md-12">
                    {!! Form::open(['route'=>'docenteexamen.store','method'=>'POST','class'=>'form-horizontal form-label-left'])!!}
                    ...
                    <div class="form-group">
                        <div class="col-md-12">
                            {!! Form::label('docenteacademico_id', 'Seleccione el Par', ['class' => 'control-label'])!!}
                            {!! Form::select('docenteacademico_id',$docentes,null,['class'=>'form-control chosen-select','placeholder'=>'-- Seleccione una opción --','required','id'=>'tipo']) !!}
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-12">
                            <a href="{{route('docenteexamen.index')}}" class="btn btn-3d btn-danger">Cancelar</a>
