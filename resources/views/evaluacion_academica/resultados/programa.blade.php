...
<div class="col-md-12">
    <div class="alert alert-primary alert-border alert-dismissible fade in" role="alert">
        ...
        <p>La funcionalidad permite visualizar los resultados de la evaluación académica aplicada a los estudiantes, docentes y encargados de programa. Los resultados son para un docente en particular y para un programa en específico donde posee carga académica.</p>
    </div>
</div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-12" style="margin-top: 40px">
                <h3 style="color: green;">PROGRAMA: {{$programa->nombre}}</h3>
                <h3 style="color: green;">CALIFICACIÓN PONDERADA: {{$finalt}}</h3>
                <h3 style="color: green;">CALIFICACIÓN CUALITATIVA: {{$finalc}}</h3>
                <div id="imprimir"><a target="_blank" href="{{route('resultadosea.docenteprogramapdf',[$docente,$periodo,$programa->id,$unidad])}}" class="btn btn-danger btn-raised"><i class="fa fa-file-pdf-o"></i> Imprimir PDF</a></div>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr class="read">
                                ...
                                <td class="subject"><a href="{{route('resultadosea.resultadosdocenteresultadoscap',[$r['periodo'],$r['evaluacion_id'],$r['docente'],$programa->id])}}">Consultar los detalles evaluados</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
