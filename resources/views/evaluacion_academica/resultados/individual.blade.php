    ...
    <div class="panel-body">
        <div class="col-md-12">
            ...
            <p class="animated fadeInDown">
                <a href="{{route('inicio')}}">Inicio</a> <span class="fa-angle-right fa"></span> <a href="{{route('admin.evaluacionautohetero')}}"> Módulo Evaluación Académica</a> <span class="fa-angle-right fa"></span> <a href="{{route('resultadosea.inicio')}}"> Resultados Evaluación Académica</a> <span class="fa-angle-right fa"></span> Resultados Individuales 
            </p>
        </div>
    </div>
</div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="col-md-12" style="margin-top: 40px">
                ...
                <div id="imprimir"><a target="_blank" href="{{route('resultadosea.docenteindividualpdf',[$doc,$per])}}" class="btn btn-danger btn-raised"><i class="fa fa-file-pdf-o"></i> Imprimir PDF</a></div>
                    ...
                    <table class="table table-hover">
                        <tbody>
                            ...
                            <tr class="read">
                                ...
                                <td class="subject"><a href="{{route('resultadosea.resultadosdocenteresultadosca',[$r['periodo'],$r['evaluacion_id'],$r['docente']])}}">Consultar los detalles evaluados</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
