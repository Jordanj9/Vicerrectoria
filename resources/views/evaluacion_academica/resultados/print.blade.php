        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <table style='width: 100%;'>
                    <tbody>
                        <tr>
                            <th style='width: 10% !important; background-color:#2196F3; color:#FFFFFF; font-size: 13px'>NOTACIÓN</th>
                            <th style='width: 45% !important; background-color:#2196F3; color:#FFFFFF; font-size: 13px'>DESCRIPCIÓN</th>
                        ...
                        @foreach($eval as $ev)
                        <tr>
                            <td style='width: 10% !important; background-color: #ecf0f1;'>{{$ev->acronimo}}</td>
                            <td style='width: 45% !important; background-color: #ecf0f1;'>{{$ev->descripcion}}</td>
                ...
                <table style='width: 100%;'>
                    <thead>
                        <tr>
                            <th style='width: 100% !important; background-color: #ed4c1b; color:#FFFFFF; font-size:13px;'>OBSERVACIONES</th>
                        </tr>
                    </thead>
                </table>
            ...
            <br>
            <p>______________________________________________</p>
            <p>FIRMA RESPONSABLE DE PROGRAMA</p>
            <br>
            <p>FECHA: _______________________________________</p>
        </div>
    </body>
</html>